...
By accessing or using the Accurate Medical Centre Hospital Management System (HMS) — including the web application, patient portal, staff dashboards, mobile application, and any associated services (collectively, the "Services") — you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the Services.

These Terms constitute a legally binding agreement between you ("User," "you," "your") and Accurate Medical Centre ("we," "us," "our," "the Hospital"). They govern your use of the Services, including the patient portal, staff interfaces, appointment booking, medical record access, and any mobile applications.
...
- Interfere with system integrity (e.g., scraping, automated scripts, denial-of-service).
- Transmit malware, malicious code, or harmful content.
- Impersonate another user or misrepresent your identity or role.
- Export, scrape, or bulk-download data without written authorization.
- Use the Services for commercial purposes not authorized by the Hospital.
- Violate intellectual property rights (the HMS, its code, design, and content are proprietary).

Violation may result in immediate account suspension, termination, and legal action.
...
- We process data for healthcare delivery, billing, operations, and compliance.
- We do not sell your data.
- You have rights under NDPR (access, rectification, erasure, portability, objection).
- Data is stored on secure cloud infrastructure (Supabase, Vercel, Cloudinary) with encryption.
- Contact our Privacy Officer: accuratemedicalcenterofficial@gmail.com
...
- ACCURACY, COMPLETENESS, OR CURRENCY OF CLINICAL CONTENT OR DECISION SUPPORT.
- THAT THE SERVICES WILL MEET YOUR REQUIREMENTS OR BE COMPATIBLE WITH ALL DEVICES.

CLINICAL INFORMATION IS FOR REFERENCE ONLY AND DOES NOT CONSTITUTE MEDICAL ADVICE. ALWAYS CONSULT A QUALIFIED HEALTHCARE PROVIDER FOR DIAGNOSIS AND TREATMENT.
...
- WE ARE NOT LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES (INCLUDING LOST PROFITS, DATA LOSS, OR BUSINESS INTERRUPTION) ARISING FROM YOUR USE OF THE SERVICES.
- OUR TOTAL AGGREGATE LIABILITY FOR ANY CLAIM ARISING FROM THESE TERMS SHALL NOT EXCEED THE FEES PAID BY YOU IN THE 12 MONTHS PRECEDING THE CLAIM, OR ₦100,000, WHICHEVER IS GREATER.
- THIS LIMITATION APPLIES REGARDLESS OF LEGAL THEORY (CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY).

THIS LIMITATION DOES NOT APPLY TO LIABILITY FOR DEATH OR PERSONAL INJURY CAUSED BY OUR NEGLIGENCE, FRAUD, OR WHERE PROHIBITED BY LAW.

---

## 11. Indemnification

You agree to indemnify, defend, and hold harmless Accurate Medical Centre, its directors, officers, employees, agents, and affiliates from and against any claims, damages, losses, liabilities, costs, and expenses (including reasonable legal fees) arising from:

- Your breach of these Terms.
- Your misuse of the Services.
- Your violation of any law or third-party rights.
- Content you submit or transmit via the Services.
...
We are not liable for failure or delay in performance due to events beyond our reasonable control: natural disasters, pandemics, government actions, labor disputes, infrastructure failures, cyberattacks, or third-party service outages. Performance is excused for the duration of the event.
...
- Prominent notice on the Services 30 days before effective date.
- Email to registered users.
- Updated "Effective Date" and version number.

Continued use after the effective date constitutes acceptance. If you disagree, you must cease use and may terminate your account.
...
Website: https://accuratemedicalcenter.com

For questions about these Terms, contact our Legal/Compliance team at the above address.
