...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    ...
    <div data-auth className="flex min-h-screen min-h-[100svh] flex-col overflow-hidden bg-[var(--marketing-ivory)] lg:grid lg:grid-cols-[minmax(24rem,0.82fr)_minmax(34rem,1.18fr)]">
      {/* Left Pane - Auth Form */}
      ...
      <div className="order-1 relative flex min-h-[300px] w-full overflow-hidden bg-[var(--marketing-ink)] sm:min-h-[360px] lg:order-2 lg:min-h-screen">
            ...
            <div className="auth-reveal hidden grid-cols-1 gap-7 border-t border-white/[0.14] pt-8 sm:grid-cols-3 sm:gap-6 lg:grid" style={{ animationDelay: "360ms" }}>
              <div className="space-y-3 border-l border-white/[0.12] pl-4">
                <div className="flex h-9 w-9 items-center justify-center rounded-full border border-white/[0.16] bg-white/[0.08]">
                  <Stethoscope aria-hidden className="h-4 w-4" style={{ color: "var(--primary)" }} />
                </div>
              ...
              <div className="space-y-3 border-l border-white/[0.12] pl-4">
                <div className="flex h-9 w-9 items-center justify-center rounded-full border border-white/[0.16] bg-white/[0.08]">
                  <ShieldCheck aria-hidden className="h-4 w-4" style={{ color: "var(--primary)" }} />
                </div>
              ...
              <div className="space-y-3 border-l border-white/[0.12] pl-4">
                <div className="flex h-9 w-9 items-center justify-center rounded-full border border-white/[0.16] bg-white/[0.08]">
                  <Clock aria-hidden className="h-4 w-4" style={{ color: "var(--primary)" }} />
                </div>
